...
class MERInterface:
    """User-friendly interface for the GAN-based Music Emotion Recognition system"""
    ...
    def __init__(self, models_dir: str = "models", dataset_dir: str = "EMOPIA_1.0"):
        ...
        if os.path.exists(models_dir):
            try:
                ...
                print("You may need to train the models first by running main.py")
        else:
            print(f"⚠ Warning: Models directory {models_dir} not found")
            print("You need to train the models first by running main.py")
...
def main():
    """Command-line interface for the MER system"""
    parser = argparse.ArgumentParser(description="GAN-based Music Emotion Recognition System")
    ...
    interface = MERInterface(args.models_dir, args.dataset_dir)
